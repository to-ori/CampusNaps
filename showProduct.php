...
<!------ end of animated banner---->
		...
		<div id="clock" style="position:relative;left:600px;top:-20px"><br></div>
			...
			<div class="nav">
				...
				<br>
				<br>
				<li><a  class="active" href="adminAccessProduct.php">Admin: Products</a></li>
				<br>
				<br>
				</ul>
				</div>
...
if ($result = $conn->query("SELECT * FROM CampusNapProduct ORDER BY id"))
{
...
// set table headers
echo "<tr><th>ID</th><th>Product Name</th><th>Product Description</th><th>Price per Unit</th><th>Stock Level</th><th>Notes</th><th></th><th></th></tr>";
...
echo "<td>" . $row->p_stock_level . "</td>";
echo "<td>" . $row->notes . "</td>";
echo "<td><a href='productRecords.php?id=" . $row->id . "'>Edit</a></td>";
...
<a href="productRecords.php">Add New Record</a>
</div>
			<!----------Footer----------------->
			<div class="footer">
